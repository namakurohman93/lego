...
func Get(u string, p UrlParams, f bool) (r *response.Response, err error) {
...
func PostForm(u string, p UrlParams, b IPayload, f bool) (r *response.Response, err error) {
...
func PostJson(u string, p UrlParams, b IPayload, f bool) (r *response.Response, err error) {
	reqBody, err := b.GetBody()
	if err != nil {
		return
	}
